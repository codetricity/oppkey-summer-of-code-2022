...
This tutorial is the eigth in a series aimed at helping developers learn how to work with the RICOH THETA X camera. It focuses on using the API to 
...
in a row, all stored on Google's Firestore (cloud storage). It has the advantage of multi-plaform support: it works on Windows, MacOS, iOS, Linux.
