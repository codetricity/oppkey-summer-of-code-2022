---
title: "02. Using RICOH THETA API Response to Update App Screen"
date: "2022-06-08"
hero_image: "./staff.png"
hero_image_alt: "staff shot taken with basic application"
hero_image_credit_text: "Oppkey Developer Intern - caitlynbakery"
hero_image_credit_link: "https://github.com/caitlynbakery"
---

# Using State Management to show output from API commands

This tutorial is the second in a series aimed at helping developers learn how to work with the RICOH THETA X camera. It focuses on using the API to build a mobile app. The examples provided use Flutter to build mobile apps. Source code is downloadable from GitHub.
