...
date: "2022-06-29"
hero_image: "./04_screenshot.png"
hero_image_alt: "camera settings screen"
hero_image_credit_text: "Oppkey"
...
There are many options for camera settings.  On strategy to organize the UI for a large number of configuration options is 
