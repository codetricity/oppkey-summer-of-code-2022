---
title: "01. RICOH THETA API Camera Connection"
date: "2022-08-06"
...
This tutorial is the first in a series aimed at helping developers learn how to work with the RICOH THETA X camera. It focuses on using the API to build a mobile app. The examples provided use Flutter to build mobile apps. Source code is downloadable from GitHub.
...
* The camera works as a hotspot, you connect to it via Wi-Fi. Example: 

![hotspot_example](./hotspot.png)
